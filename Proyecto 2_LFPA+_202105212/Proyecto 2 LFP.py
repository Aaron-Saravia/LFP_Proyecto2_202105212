...
tokens ={
    ...
    "tk_true": "true",
    "tk_false": "false",
    "tk_control_a": "<!--Controles",
    "tk_control_c": "Controles -->",
    "tk_props_a": "<!--propiedades",
    "tk_props_c": "propiedades -->",
    "tk_coloca_a": "<!--Colocacion",
    "tk_coloca_c": "Colocacion -->",
    "tk_Etiqueta": "Etiqueta",
    "tk_Boton": "Boton",
    "tk_Check": "Check",
    "tk_RadioBoton": "RadioBoton",
    "tk_Texto": "Texto",
    "tk_AreaTexto": "AreaTexto",
    "tk_Clave": "Clave",
    "tk_Contenedor": "Contenedor",
    "tk_setcolorLetra": "setColorLetra",
    "tk_setTexto": "setTexto",
    "tk_setAlineacion": "setAlineacion",
    "tk_setbgcolor": "setColorFondo",
...
def Datos_user():
    messagebox.showinfo(message='''Actualmente (Año 2022) es estudiante de Lenguajes Formales y de Programacion en la USAC:
...
def verTokens():
    ...
    lbltokens.pack()
    btn_Regresar = customtkinter.CTkButton(toplevel, text= "Regresar", text_font=("Showcard Gothic", 10, "bold"), command =lambda: Salir(toplevel),
    ...
    columnas = ("num","lin","col","token","lexema")
    T_tokens = ttk.Treeview(toplevel, columns=columnas, show="headings")
...
root.config(borderwidth=20, bg="green")
...
lblcodigo = Label ( root, text="Escribe tu codigo en esta area", font=("Showcard Gothic", 10, "bold"), bg = "green")
lblcodigo.grid(row=0,column=0)

lblopciones = Label ( root, text="Opciones", font=("Showcard Gothic", 10, "bold"), bg = "green")
...
lblmenuArchivo = Label ( root, text="Archivo: ", font=("Showcard Gothic", 10, "bold"), bg = "green")
lblmenuArchivo.grid(row=1,column=1, sticky="w")

btn_Nuevo = customtkinter.CTkButton(root, text= "Nuevo", text_font=("Showcard Gothic", 10, "bold"), command =lambda: Nuevo(T_codigo),
    text_color="Black", hover= True, hover_color= "#f2f2f2", height=30, width= 100, border_width=2, corner_radius=20,
    border_color= "#d3d3d3", bg_color="green", fg_color= "#fafafa")
btn_Nuevo.grid(row=2,column=1, sticky="news", padx=10, pady=10)

btn_Abrir = customtkinter.CTkButton(root, text= "Abrir", text_font=("Showcard Gothic", 10, "bold"), command =lambda: Abrir(T_codigo),
    text_color="Black", hover= True, hover_color= "#f2f2f2", height=30, width= 100, border_width=2, corner_radius=20,
    border_color= "#d3d3d3", bg_color="green", fg_color= "#fafafa")
btn_Abrir.grid(row=2,column=2, sticky="news", padx=10, pady=10)

btn_Guardar = customtkinter.CTkButton(root, text= "Guardar", text_font=("Showcard Gothic", 10, "bold"), command =lambda: Guardar(T_codigo),
    text_color="Black", hover= True, hover_color= "#f2f2f2", height=30, width= 100, border_width=2, corner_radius=20,
    border_color= "#d3d3d3", bg_color="green", fg_color= "#fafafa")
btn_Guardar.grid(row=3,column=1, sticky="news", padx=10, pady=10)

btn_GuardarC = customtkinter.CTkButton(root, text= "Guardar Como", text_font=("Showcard Gothic", 10, "bold"), command =lambda: GuardarC(T_codigo),
    text_color="Black", hover= True, hover_color= "#f2f2f2", height=30, width= 100, border_width=2, corner_radius=20,
    border_color= "#d3d3d3", bg_color="green", fg_color= "#fafafa")
btn_GuardarC.grid(row=3,column=2, sticky="news", padx=10, pady=10)

btn_Salir = customtkinter.CTkButton(root, text="Salir", text_font=("Showcard Gothic", 10, "bold"), command =lambda: Salir(root),
    text_color="Black", hover= True, hover_color= "#f2f2f2", height=30, width= 100, border_width=2, corner_radius=20,
    border_color= "#d3d3d3", bg_color="green", fg_color= "#fafafa")
btn_Salir.place(x=750, y=190)

btn_Datos = customtkinter.CTkButton(root, text="Temas de ayuda", text_font=("Showcard Gothic", 10, "bold"), command =Datos_user,
    text_color="Black", hover= True, hover_color= "#f2f2f2", height=30, width= 100, border_width=2, corner_radius=20,
    border_color= "#d3d3d3", bg_color="green", fg_color= "#fafafa")
btn_Datos.place(x=965, y=190)

lblmenuAnalisis = Label( root, text="Analisis: ", font=("Showcard Gothic", 10, "bold"), bg = "green")
lblmenuAnalisis.grid(row=5,column=1, sticky="w")

lblmenuTokens = Label( root, text="Tokens: ", font=("Showcard Gothic", 10, "bold"), bg = "green")
lblmenuTokens.grid(row=7,column=1, sticky="w")

btn_Manual_user = customtkinter.CTkButton(root, text="Manual de Usuario", text_font=("Showcard Gothic", 10, "bold"), command =Manual_user,
    text_color="Black", hover= True, hover_color= "#f2f2f2", height=30, width= 100, border_width=2, corner_radius=20,
    border_color= "#d3d3d3", bg_color="green", fg_color= "#fafafa")
btn_Manual_user.place(x=950, y=240)

btn_Manual_Tec = customtkinter.CTkButton(root, text="Manual de Tecnico", text_font=("Showcard Gothic", 10, "bold"), command =Manual_Tec,
    text_color="Black", hover= True, hover_color= "#f2f2f2", height=30, width= 100, border_width=2, corner_radius=20,
    border_color= "#d3d3d3", bg_color="green", fg_color= "#fafafa")
btn_Manual_Tec.place(x=950, y=290)

btn_Tokens = customtkinter.CTkButton(root, text="Ver Tokens", text_font=("Showcard Gothic", 10, "bold"), command =verTokens,
    text_color="Black", hover= True, hover_color= "#f2f2f2", height=30, width= 100, border_width=2, corner_radius=20,
    border_color= "#d3d3d3", bg_color="green", fg_color= "#fafafa")
btn_Tokens.place(x=725, y=290)

lblerrores = Label( root, text="Area de Errores ", font=("Showcard Gothic", 10, "bold"), bg = "green")
...
btn_Generar = customtkinter.CTkButton(root, text="Generar Pagina web", text_font=("Showcard Gothic", 10, "bold"), command =lambda: Analizar(T_codigo,T_error),
    text_color="Black", hover= True, hover_color= "#f2f2f2", height=30, width= 100, border_width=2, corner_radius=20,
    border_color= "#d3d3d3", bg_color="green", fg_color= "#fafafa")
btn_Generar.place(x=690, y=240)
